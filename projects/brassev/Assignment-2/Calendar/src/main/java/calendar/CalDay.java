...
public class CalDay {
	...
	*/
	...
	public void addAppt(Appt appt) {
		if (appt.getValid()) {
		    // BUG: Are we assuming that Appointments with no_time (-1 for hour) should appear first?  Maybe make a comment if that assumption is correct.
...
//			sb.append(this.appts);
	...
	*	the specified data.
	**/
	// NOTE: This is either an ingenious Emperor's New Groove reference, or the most vague, useless comment that I've ever seen.  I have know idea what the specified behavior of this function should be.  How can I test it?
	// BUG: Rename getFullInfomrationApp to getFullInformationApp
    public String getFullInfomrationApp( Object calday) {
        // BUG: Why not use this?  Why a generic object and then all the casts?  Doing something like this needs to have an explanation comment.
        // BUG: Either remove the parameter and use this, or else make this a static method.
