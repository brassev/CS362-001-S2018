...
public class Appt{
    ...
    public Appt(int startDay, int startMonth, int startYear,
         ...
         this(-2, -2, startDay, startMonth, startYear, title,
            description, emailAddress);
         // BUG: startHour and startMinute should be NO_TIME (-1) not -2
         this.valid=true;
    }
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
		    ...
		    // BUG: startHour could be -1 meaning NO_TIME
			this.valid = false;
		else if (startMinute < 0 || startHour > 59)
		    // BUG: startMinute could be -1 which means NO_TIME
		    // BUG: The second conditional of the above line should be StartMinute
			this.valid = false;
		else if (startYear <= 0)
			this.valid = false;
		else {
    ...
    /** Sets emailAddress */
    // BUG: Why is this private?  Shouldn't it be public like the rest of setters/getters?
     ...
     */
    // BUG: These function produce a string that is nothing like this comment describes
    private String representationApp(){
        ...
        // BUG: This doesn't handle NO_TIME in any way.
        // BUG: This won't handle minutes with single digits properly.  Eg. it would output 11:1 instead of 11:01 as would be expected.  Also: 12:0 instead of 12:00
		// BUG: This will never return just 11am: like the comment above says.
		// NOTE: Where is the ending ":" and " "?
        // BUG: This is probably intended to be called representationApp
    ...
    public String toString()
    {
		...
		if (!getValid()) {
		    ...
		    // BUG: No special representation for an invalid appointment?
		}
